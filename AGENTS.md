# AGENTS.md — opera-sieve

## Role: META / INFRASTRUCTURE

**Cluster:** Infrastructure

**Core claim:** Sieve infrastructure and prime-gap enumeration supporting all clusters
...
Look for `kernel.py`, `lean-proof/`, or sieve Lean files.
...
| [DavidFox998/morningstar-project](https://github.com/DavidFox998/morningstar-project) | sibling in cluster |
