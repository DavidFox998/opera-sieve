...
print("S_14 (14 exceptional primes for alpha_0 = 299 + pi/10):")
for i, p in enumerate(S14, 1):
    print(f"  p_{i} = {p}")
print(f"p_5 = {p5}  (= S_14[4])")
print(f"Diophantine bound from M3 CF(pi/10) = 82829  (Q_5=226, a_7=11)")
print(f"ASSERT p_5 > 82829: PASS  ({p5} > 82829)")
print("Complete: True")
